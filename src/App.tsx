...
export default function Home() {
  ...
  return <main>
    <header className="topbar"><a className="brand" href="#top"><span>查</span><div><b>食安違規查核台</b><small>FREE COMPLIANCE CHECK</small></div></a><div className="top-actions"><button className="database-link" onClick={openDatabase}>查看已收錄資料</button><div className="period"><i />滾動查核期間：{dateLabel}</div></div></header>
